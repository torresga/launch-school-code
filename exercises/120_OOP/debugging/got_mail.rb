...
# Solution changes the name of this method
  def send_mailing(destination, mail)
...
# I think this class needs to include the Mailing method
...
# I wonder if this was interpreted as using Object#send?
puts johns_postal_service.send_mailing(ellens_postal_service.street_address, Postcard.new('Greetings from Silicon Valley!'))
