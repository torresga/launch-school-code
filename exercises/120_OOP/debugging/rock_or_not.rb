...
# This class raises an exception when called by itself
class SearchEngine
...
module DoesItRock
  ...
  class Score
    def self.for_term(term)
      # These two variables contain NoScore
  ...
  def self.find_out(term)
    ...
    # When we output score, it returns NoScore
    ...
    when 0.5
      "#{term} seems to be ok..."
    # Since score is a class object, this triggers the else clause
    else
      "#{term} rocks!"
    end
