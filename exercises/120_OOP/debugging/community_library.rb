...
# The exception raised is a NoMethodError. Array does not have a display_data method.
...
class Library
  ...
  # We can create a method inside Library that displays data for each book:
  def display_books
    books.each do |book|
      book.display_data
    end
...
# call display_books on the Library object
