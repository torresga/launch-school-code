...
class BankAccount
  ...
  # the first expression following the if statement only checks if amount is greater than 0. we also have to check if amount is less than or equal to balance.
  def withdraw(amount)
