...
class Employee
  ...
  # serial_number is originally a private method, and here serial_number is called with an explicit receiver
  def ==(other)
  ...
  # We can make serial_number protected to keep it not callable from outside the clas, but we can call it with an explicit receiver
  protected
